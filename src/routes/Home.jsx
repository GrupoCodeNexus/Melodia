...
import CarrosselManual from '../components/CarrosselManual'; // Importe o componente CarrosselManual

const Home = () => {
  return (
    <>
      <main>
        <div className="banner-home"> {/*banner de fundo e o h1, p e button por cima dele*/}
